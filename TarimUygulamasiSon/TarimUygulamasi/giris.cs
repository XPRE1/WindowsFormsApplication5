...
namespace TarimUygulamasi
{
    public partial class giris : Form
    {
        ...
        private void girisButonu_Click(object sender, EventArgs e)
        {
            ...
            //kullanıcılar tablosunda girilen bilgilerin var olup olmadığını kontrol edildi.
            SqlCommand sorgu = new SqlCommand("SELECT k_adi, k_sifre FROM Kullanicilar WHERE k_adi='" + kullaniciAdi.Text + "' AND k_sifre='" + sifre.Text + "'", baglanti);
